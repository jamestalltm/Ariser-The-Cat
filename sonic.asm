...
GM_Title:
    ...
    Title_ClrObjRam2:
		...
		;clr.b	(v_objspace+$80+obRoutine).w ; The 'Mega Games 10' version of Sonic 1 added this line, to fix the 'PRESS START BUTTON' object appearing
...
LevSel_NoCheat:
		...
		cmpi.w	#bgm__Last+1,d0	; is sound $80-$9F being played?
		blo.s	LevSel_PlaySnd	; if yes, branch
		cmpi.w	#sfx__First,d0	; is sound $A0 being played?
...
LevSel_Level_SS:
		...
		move.b	#2,(v_lives).w	; set lives to 2
		moveq	#0,d0
...
LevelMenuText:	if Revision=0
		lstxt "PIPE GREENS      STAGE 1"
		lstxt "                 STAGE 2"
		lstxt "                 STAGE 3"
		lstxt "CRYSTAL TEMPLES  STAGE 1"
		lstxt "                 STAGE 2"
		lstxt "                 STAGE 3"
		lstxt "TEMPLE RUINS     STAGE 1"
		lstxt "                 STAGE 2"
		lstxt "                 STAGE 3"
		lstxt "STAR CITY        STAGE 1"
		lstxt "                 STAGE 2"
		lstxt "                 STAGE 3"
		lstxt "PARKOR CITY      STAGE 1"
		lstxt "                 STAGE 2"
		lstxt "                 STAGE 3"
		lstxt "MAD FACTORY      STAGE 1"
		lstxt "                 STAGE 2"
		lstxt "                 STAGE 3"
		lstxt "FINAL ZONE              "
		lstxt "SPECIAL STAGE           "
...
GM_Ending:
	...
	End_ClrRam3:
		...
		move.w	#(id_EndZ<<8)+1,(v_zone).w ; set level number to 0600 (no flowers)
...
GM_Credits:				; XREF: GameModeArray
	...
	Cred_SkipObjGfx:
		...
		move.w	#500,(v_demolength).w ; display a credit for 2 seconds
		bsr.w	PaletteFadeIn
...
TryAgainEnd:
	...
	TryAg_ClrPal:
		...
		move.b	#id_EndEggman,(v_objspace+$100).w ; load Eggman object
		jsr	(ExecuteObjects).l
		jsr	(BuildSprites).l
...
M_Got_SonicHas:	dc.b $A	; ARISER HAS
		dc.b $F8, 5, 0, 0, $A8
		dc.b $F8, 5, 0, $3A, $B8
		dc.b $F8, 1, 0, $20, $C8
		dc.b $F8, 5, 0, $3E, $D0
...
M_SSR_Chaos:	dc.b $D			; "CHAOS CRYSTALS"
		dc.b $F8, 5, 0, 8, $8C	
		dc.b $F8, 5, 0, $1C, $9C	
		dc.b $F8, 5, 0, 0, $AC	
		dc.b $F8, 5, 0, $32, $BC	
...
byte_CD6B:	dc.b $C			; "SPECIAL STAGE"
		...
		dc.b $F8, 5, 0,	$18, $44
		dc.b $F8, 5, 0,	$10, $54
byte_CDA8:	dc.b $F			; "ARISER GOT THEM ALL"
		dc.b $F8, 5, 0, 0, $64	
		dc.b $F8, 5, 0, $3A, $74	
		dc.b $F8, 1, 0, $20, $84	
		dc.b $F8, 5, 0, $3E, $8C	
