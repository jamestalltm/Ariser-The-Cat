...
PlaySoundID:
		...
		; DANGER! Music ends at $9F, yet this checks until $FF; attempting to
		; play sounds $E0-$FF will cause a crash! Remove the '+$C' to fix this.
...
Music93:	incbin	"sound/music/Mus93 - Get Emerald.bin"
		even
Music94:	incbin	"sound/music/Mus94.bin"
		even
Music95:	incbin	"sound/music/Mus95.bin"
		even
Music96:	incbin	"sound/music/Mus96.bin"
		even
Music97:	incbin	"sound/music/Mus97.bin"
      even
Music98:	incbin	"sound/music/Mus98.bin"
      even
Music99:	incbin	"sound/music/Mus99.bin"
      even
Music9A:	incbin	"sound/music/Mus9A.bin"
      even
Music9B:	incbin	"sound/music/Mus9B.bin"
      even
Music9C:	incbin	"sound/music/Mus9C.bin"
      even
Music9D:	incbin	"sound/music/Mus9D.bin"
      even
Music9F:	incbin	"sound/music/Mus9F.bin"
      even
; ---------------------------------------------------------------------------
